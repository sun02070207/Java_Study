...
三、Comparable 与 Comparator的使用对比
...
public class CompareTest {
    ...
    2. 像String、包装类重写compareTo(obj)方法以后，进行从小到大排列
     ...
     */
    public void test(){
        String[] arr = new String[]{"AA", "BC", "BB", "GG", "DD", "ab"};
        //
        Arrays.sort(arr);
    ...
    2.重写compare(Object o1,Object o2)方法，比较形参o1和o2的大小：如果方法返
    回正整数，则表示o1大于o2；如果返回0，表示相等；返回负整数，表示
    o1小于o2。
     */
    @Test
    public void test3(){
        String[] arr = new String[]{"AA", "BC", "BB", "GG", "DD", "ab", "BG", "GC"};
        //
